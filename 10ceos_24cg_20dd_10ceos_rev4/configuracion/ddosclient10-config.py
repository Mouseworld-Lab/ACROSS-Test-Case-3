...
# Comando para agregar la direcciÛn IP en la interfaz eth1
comando_addr = "ip addr add 11.0.10.1/24 dev eth1"
...
# Ejecutar el comando de verificaci‚àö‚â•n
