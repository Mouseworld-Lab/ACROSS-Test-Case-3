...
comando_addr_eth1 = "ip addr add 10.0.19.10/24 dev eth1"
subprocess.run(comando_addr_eth1, shell=True)

comando_addr_eth2 = "ip addr add 11.0.19.11/24 dev eth2"
...
puerta_enlace = "10.0.19.9"
interfaz = "eth1"

puerta_enlace_eth2 = "11.0.19.1"
interfaz_eth2 = "eth2"
